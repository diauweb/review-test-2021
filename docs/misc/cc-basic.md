---
author: Yufan, Great-designer, mgt, Chrogeek, Margatroid, ouuan, Ir1dXD,
  MrFoodinChina, pw384
title: 计算理论基础
tags:
  - misc
...
:::details[停机问题是图灵不可计算的证明]{.note open="false"}
...
:::details[确定性时间谱系定理的证明]{.note open="false"}
...
:::details[为什么 NP?=co-NP 不是显然的？]{.note open="true"}
