...
:::details[例题 1 [leetcode 713. 乘积小于 K 的子数组](https://leetcode-cn.com/problems/subarray-product-less-than-k/)]{.note open="true"}
...
:::details[例题 2 [luogu P3066 Running Away From the Barn G](https://www.luogu.com.cn/problem/P3066)]{.note open="true"}
...
:::details[例题 3 [leetcode 524. 通过删除字母匹配到字典里最长单词](https://leetcode-cn.com/problems/longest-word-in-dictionary-through-deleting/)]{.note open="true"}
...
:::details[例题 4 [leetcode 167. 两数之和 II - 输入有序数组](https://leetcode-cn.com/problems/two-sum-ii-input-array-is-sorted/)]{.note open="true"}
