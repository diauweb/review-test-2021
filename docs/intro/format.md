---
author: henry_23, 夜轮_NachtgeistW, mgt, kenlig, Coelacanthus, Alisa,
  Great-designer, Shuhao, Coelacanthus, Coelacanthus, zwuis, 夜轮_NachtgeistW,
  Margatroid, StudyingFather, Chrogeek, NachtgeistW, Xiaodai
title: 格式手册
tags:
  - intro
...
*   建议使用主题扩展的 `???+note` 格式（即 [Collapsible Blocks](https://squidfunk.github.io/mkdocs-material/reference/admonitions/#collapsible-blocks)）来描述题面和参考代码。也可以用这种格式来展示其他需要补充介绍的内容。
    ...
    :::details[标题]{.note open="false"}
    这个文本框会被默认折叠。

    推荐将 **解题代码** 放在折叠文本框内。
    :::

    :::details[[HDOJ 的“A + B Problem”](http://acm.hdu.edu.cn/showproblem.php?pid=1000)]{.note open="true"}
    标题也可以使用 Markdown 的超链接。这里的超链接是 HDOJ 的“A + B Problem”。
...
*   请尽量为链接提供完整的标题、或者可被识别的提示，避免使用裸地址和“这”、“此”之类的模糊不清的描述。每一个超链接都应尽量对其加以清楚明确的描述，方便读者明白该超链接将指向何处。
    ...
    :::details[success "推荐的写法]{open="true"}
    ```markdown
...
*   [标点符号用法（GB/T 15834—2011）](http://www.moe.gov.cn/s78/A19/yxs\_left/moe\_810/s230/201001/W020190128580990138234.pdf)
