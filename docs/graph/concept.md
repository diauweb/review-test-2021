---
author: 小H, Yufan, EndlessCheng, Great-designer, mgt, Early, Sshwy, SingerCoder,
  zidian257@15in-mbp, Margatroid, Steaunk, Ir1dXD, ouuan
title: 图论相关概念
tags:
  - graph
...
:::details[为什么起点是 Tail，终点是 Head？]{.note open="true"}
...
求一张普通图或二分图的匹配或完美匹配个数都是 [#P 完全](../misc/cc-basic.md#p\_1) 的。
...
[Wikipedia](https://en.wikipedia.org/wiki/Glossary\_of\_graph\_theory\_terms)（以及相关概念的对应词条）
