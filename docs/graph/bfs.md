---
author: Z., ksyx, CoderOJ, kenlig, WenzelTian, Shuhao, mgt, qq2964, Henry-ZHR,
  H-J-Granger, Ir1dXD, SaltedFishAJLC, EndlessCheng, ouuan, abc1763613206,
  Joshua, sshwy, hewenyang
title: BFS（图论）
tags:
  - graph
...
BFS 全称是 [Breadth First Search](https://en.wikipedia.org/wiki/Breadth-first\_search)，中文名是宽度优先搜索，也叫广度优先搜索。
