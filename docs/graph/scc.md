---
author: WenzelTian, Nathan, 小H, mgt, 邵晨恒, H-J-Granger, StevenChen, LiJianzhu,
  Han, ouuan, Ir1d, Douglas, sshwy, 雷蒻, Anguei, Siger, Xeonacid, qq2964, RedWind
title: 强连通分量
tags:
  - graph
...
3.  横叉边（cross edge）：示意图中以蓝色边表示（即 $9 \rightarrow 7$），它主要是在搜索的时候遇到了一个已经访问过的结点，但是这个结点 **并不是** 当前结点的祖先时形成的。
