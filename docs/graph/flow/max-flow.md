---
author: Danni, black_desk, black_desk, Lin2602, qq2964, mgt, peterlits, Shuhao,
  Chrogeek, Ir1d, ouuan, Yaoyao, Wang, Trisolaris, frank, Xeonacid, Yaoyao,
  orzcyand1317
title: 最大流
tags:
  - graph
...
:::details[LuoguP4722【模板】最大流 加强版/预流推进]{open="false"}
```cpp
#include <cstdio>
#include <cstring>
#include <queue>
