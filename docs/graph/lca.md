---
author: kenlig, peterlits, Zhikai, imp, mgt, XTh3G4p, Early, Nano, H-J-Granger,
  Henry-ZHR, countercurrent_time, ouuan, Xiaodai, therehello, Ir1d, 雷蒻,
  hewenyang, Sshwy, Trisolaris, ttzztztz, TrisolarisHD, Lan, HeRaNO, CJSoft,
  Travis
title: 最近公共祖先
tags:
  - graph
...
> 本节 **性质** 部分内容翻译自 [wcipeg](http://wcipeg.com/wiki/Lowest\_common\_ancestor)，并做过修改。
