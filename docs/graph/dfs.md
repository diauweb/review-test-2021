---
author: Z., WenzelTian, Shuhao, mgt, sshwy, XTh3G4p, ouuan, hewenyang
title: DFS（图论）
tags:
  - graph
...
DFS 全称是 [Depth First Search](https://en.wikipedia.org/wiki/Depth-first\_search)，中文名是深度优先搜索，是一种用于遍历或搜索树或图的算法。所谓深度优先，就是说每次都尝试向更深的节点走。
