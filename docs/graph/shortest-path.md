---
author: WenzelTian, Reqwey, shenyouran, Shuhao, Nathan, Ren, XTh3G4p, Danni,
  mgt, Xeonacid, peterlits, zyj2297349886, Chrogeek, H-J-Granger, ouuan,
  qiqiworld, Ir1d, TrisolarisHD, Chro, Anguei, 心旷神怡, Steaunk, AndrewWayne,
  MingqiHuang, Xeonacid, AljcC
title: 最短路
tags:
  - graph
...
:::details[证明第一维对结果无影响]{.note open="true"}
...
:::details[给一个正权无向图，找一个最小权值和的环。]{.question open="true"}
首先这一定是一个简单环。
...
:::details[已知一个有向图中任意两点之间是否有连边，要求判断任意两点是否连通。]{.question open="true"}
该问题即是求 **图的传递闭包**。
...
:::details[负环判断中存在的常见误区]{.warning open="true"}
...
:::details[Bellman-Ford 的其他优化]{.note open="true"}
...
[^1]: [Worst case of fibonacci heap - Wikipedia](https://en.wikipedia.org/wiki/Fibonacci\_heap#Worst\_case)
