---
author: Alphnia, Nathan, mgt, Ir1d, Shiqing, XLor, Xeonacid
title: 树基础
tags:
  - graph
...
:::details[为什么不是度数恰为 $1$ ？]{.question open="true"}
考虑 $n = 1$。
:::
...
**本页面部分内容引用自博文 [二叉树：前序遍历、中序遍历、后续遍历](https://blog.csdn.net/weixin\_43357638/article/details/99730284)，遵循 CC 4.0 BY-SA 版权协议。**
