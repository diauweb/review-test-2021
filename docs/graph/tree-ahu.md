---
author: kenlig, mgt, Ir1dXD, hqztrue, Zhikai
title: AHU算法
tags:
  - graph
...
本文大部分内容译自 [Paper](http://wwwmayr.in.tum.de/konferenzen/Jass08/courses/1/smal/Smal\_Paper.pdf) 和 [Slide](https://logic.pdmi.ras.ru/\~smal/files/smal\_jass08\_slides.pdf)。参考资料里的证明会更加全面和严谨，本文做了一定的简化。
