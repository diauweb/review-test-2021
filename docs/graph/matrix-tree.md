---
author: AThousandMoon, mgt, Early, Chrogeek, Henry-ZHR, ouuan, Ir1d, Shiqing,
  TrisolarisHD
title: 矩阵树定理
tags:
  - graph
...
:::details[例题 1：[「HEOI2015」小 Z 的房间](https://loj.ac/problem/2122)]{.note open="true"}
...
:::details[例题 2：[「FJOI2007」轮状病毒](https://www.luogu.com.cn/problem/P2144)]{.note open="true"}
...
:::details[例题 3：「BZOJ3659」WHICH DREAMED IT]{.note open="true"}
**解** 本题是 BEST 定理的直接应用，但是要注意，由于题目规定“两种完成任务的方式算作不同当且仅当使用钥匙的顺序不同”，对每个欧拉回路，1 号房间可以沿着任意一条出边出发，从而答案还要乘以 1 号房间的出度。
:::

:::details[例题 4：[「联合省选 2020 A」作业题](https://loj.ac/p/3304)]{.note open="true"}
...
:::details[例题 5：[AGC051D C4](https://atcoder.jp/contests/agc051/tasks/agc051\_d)]{.note open="true"}
