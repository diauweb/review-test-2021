---
author: kenlig, Shuhao, mgt, maoyiting, fearlessxjdx, Chrogeek, H-J-Granger,
  Henry-ZHR, Haoshen, HelloEarly, qwerty756, ouuan, Yupeng, 心旷神怡,
  zhouyuyang2002, sshwy, Xeonacid
title: 树链剖分
tags:
  - graph
...
:::details[怎么有理有据地卡树剖]{.note open="false"}
...
:::details[如何构造数据将轻重边切换次数卡满]{.note open="false"}
我们可以构造这么一颗二叉树 T：
...
:::details[[CF 1009F](http://codeforces.com/contest/1009/problem/F)]{.note open="false"}
