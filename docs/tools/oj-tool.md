---
author: llh721113, Coelacanthus, Yufan, mgt, Margatroid, NachtgeistW
title: OJ 工具
tags:
  - tools
...
4.  怎样在终端里启用 tab 补全命令
    ...
    使用这个工具 [Infinidat/infi.docopt\_completion](https://github.com/Infinidat/infi.docopt\_completion) 即可。
