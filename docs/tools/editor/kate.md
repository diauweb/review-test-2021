---
author: Coelacanthus, Camber, thredreams, ksyx
title: Kate
tags:
  - tools
  - editor
...
:::details[对于 Windows 用户]{.note open="true"}
...
[^ref1]: [Arch Linux 中对该包的描述](https://archlinux.org/packages/extra/x86\_64/kate/) 中，其可选依赖了 `konsole`，描述为 `open a terminal in Kate`（在 Kate 中打开一个终端）。
