...
:::details[ST 数据目录的路径]{.note open="true"}
...
:::details[如已开启 Vintage 插件]{.note open="false"}
...
[^ref4]: [Sublime Text Git 集成](https://www.sublimetext.com/docs/git\_integration.html)
