---
author: Yichi, Coelacanthus, Ir1dXD, mgt, Shuhao, Suyun514, Jacob, Xeonacid
title: C 与 C++ 区别
tags:
  - lang
...
C99 后 C 语言支持结构体的 [指派符初始化](https://en.cppreference.com/w/c/language/struct\_initialization)，C++ 直到 C++20 才支持有顺序要求的指派符初始化（C 语言没有顺序要求也不要求必须都初始化）。
