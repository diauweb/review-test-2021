---
author: 崔泽禹, opsiff, mgt, bit00011011, Suyun514, Henry-ZHR, Jacob, Ir1d
title: C++ 标准库简介
tags:
  - lang
  - csl
...
:::details[什么是造轮子]{.note open="false"}
造轮子（[Reinventing\_the\_wheel](https://en.wikipedia.org/wiki/Reinventing\_the\_wheel)）指的是重复发明已有的算法，或者重复编写现成优化过的代码。造轮子通常耗时耗力，同时效果还没有别人好。但若是为了学习或者练习，造轮子则是必要的。
:::
