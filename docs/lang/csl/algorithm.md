---
author: Xeonacid, opsiff, mgt, SBOfGaySchool, chentingyu.20, Shuhao, Jacob, ouuan, Ir1d
title: STL 算法
tags:
  - lang
  - csl
...
:::details[`random_shuffle` 函数在最新 C++ 标准中已被移除]{.warning open="true"}
...
:::details[`lower_bound` 和 `upper_bound` 的时间复杂度]{.warning open="true"}
