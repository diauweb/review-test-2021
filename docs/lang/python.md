---
author: billchenchina, Dong, mgt, Coelacanthus, ksyx, zyouxam, Shuhao, Suyun514,
  N!no, Henry-ZHR, Henry-ZHR, ranwen, ranwen, Jacob, Ir1d, Margatroid,
  abc1763613206, sshwy
title: Python 速成
tags:
  - lang
...
:::details[何谓 [**IDLE**](https://docs.python.org/zh-cn/3/glossary.html#term-idle)？]{.note open="true"}
...
:::details[运行 `python` 还是 `python3` ？]{.note open="true"}
...
:::details[[**pip**](https://pypi.org/project/pip/) 是什么？]{.note open="true"}
...
:::details[什么是 NumPy]{.note open="false"}
...
:::details[Python]{.note open="false"}
```python3
try:  # 引入优先队列模块
    import Queue as pq  # python version < 3.0
except ImportError:
