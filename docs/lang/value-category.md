...
:::details[关于名词的翻译]{.note open="true"}
...
:::details[常见的关于左右值的误解]{.warning open="true"}
以下几种类型是经常被误认为右值的左值：
...
1.  [Value categories](https://en.cppreference.com/w/cpp/language/value\_category)
