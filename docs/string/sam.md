---
author: mgt, opsiff, ranwen, maoyiting, Luckyblock233, Margatroid, ksyx,
  Chrogeek, sshwy, Suyun514, Henry-ZHR, 周湘阳, Haoshen, Seniorious, XLor, Xiao,
  hewenyang, Ir1d, fstqwq, longlongzhu123, FFjet, Xeonacid, Trisolaris, Chro,
  abc1763613206, Kinandra, Ghastlcon, When, LeoJacob, SY, MingqiHuang, frank
title: 后缀自动机 (SAM)
tags:
  - string
...
![](./images/SAM/SA\_suffix\_links.svg)
...
**本页面主要译自博文 [Суффиксный автомат](http://e-maxx.ru/algo/suffix\_automata) 与其英文翻译版 [Suffix Automaton](https://cp-algorithms.com/string/suffix-automaton.html)。其中俄文版版权协议为 Public Domain + Leave a Link；英文版版权协议为 CC-BY-SA 4.0。**
