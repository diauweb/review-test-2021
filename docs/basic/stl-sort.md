---
author: ksyx, Great-designer, Alisa, mgt, 夜轮_NachtgeistW, ouuan, Billchenchina,
  partychicken
title: 排序相关 STL
tags:
  - basic
...
C++ 标准并未严格要求此函数的实现算法，具体实现取决于编译器。[libstdc++](https://github.com/mirrors/gcc/blob/master/libstdc++-v3/include/bits/stl\_algo.h) 和 [libc++](http://llvm.org/svn/llvm-project/libcxx/trunk/include/algorithm) 中的实现都使用了 [内省排序](./quick-sort.md#4)。

## std::nth\_element

参见：[`std::nth_element`](https://zh.cppreference.com/w/cpp/algorithm/nth\_element)
...
参见：[`std::stable_sort`](https://zh.cppreference.com/w/cpp/algorithm/stable\_sort)
...
参见：[`std::partial_sort`](https://zh.cppreference.com/w/cpp/algorithm/partial\_sort)
...
参见：[Strict weak orderings](https://en.wikipedia.org/wiki/Weak\_ordering#Strict\_weak\_orderings)
