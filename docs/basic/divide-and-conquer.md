---
author: Alisa, sshwy, WenzelTian, XTh3G4p, mgt, Melxy97, Leo, Nano,
  夜轮_NachtgeistW, Shuhao, Baron, NachtgeistW, AngelKitty, Ir1d, flyhahe,
  fudonglai, TrisolarisHD, Your, Syrone, ZhangBo1191, CaoBowen, abc1763613206
title: 递归 & 分治
tags:
  - basic
...
:::details[[437. 路径总和 III](https://leetcode-cn.com/problems/path-sum-iii/)]{.note open="true"}
...
:::details[参考代码（附注释）]{.note open="false"}
```cpp
int pathSum(TreeNode *root, int sum) {
  if (root == nullptr) return 0;
