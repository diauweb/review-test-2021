---
author: Great-designer, sshwy, ksyx, mgt, Leo, 夜轮_NachtgeistW, Nano,
  H-J-Granger, H-J-Granger, Henry-ZHR, Shuhao, Han, flylai, Trisolaris, Haoshen,
  Ir1d, CaoBowen, Billchenchina, Ran, Xeonacid, HeRaNO
title: 二分
tags:
  - basic
...
C++ 标准库中实现了查找首个不小于给定值的元素的函数 [`std::lower_bound`](https://zh.cppreference.com/w/cpp/algorithm/lower\_bound) 和查找首个大于给定值的元素的函数 [`std::upper_bound`](https://zh.cppreference.com/w/cpp/algorithm/upper\_bound)，二者均定义于头文件 `<algorithm>` 中。
...
:::details[[Luogu P1873 砍树](https://www.luogu.com.cn/problem/P1873)]{.note open="true"}
