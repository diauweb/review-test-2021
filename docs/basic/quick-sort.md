---
author: ksyx, Alisa, Nathan, WenzelTian, mgt, Banson, Xeonacid, 夜轮_NachtgeistW,
  sbofgayschool, 夜轮_NachtgeistW, Shuhao, Zhikai, Nano, sshwy, ouuan,
  Billchenchina, partychicken
title: 快速排序
tags:
  - basic
...
三路快速排序（英语：3-way Radix Quicksort）是快速排序和 [基数排序](./radix-sort.md) 的混合。它的算法思想基于 [荷兰国旗问题](https://en.wikipedia.org/wiki/Dutch\_national\_flag\_problem) 的解法。
...
[^ref1]: [C++ 性能榨汁机之局部性原理 - I'm Root lee !](http://irootlee.com/juicer\_locality/)
