---
author: mgt, H-J-Granger, ouuan, sshwy, Ir1d, GavinZhengOI, 雷蒻
title: 树状数组套主席树
tags:
  - ds
...
:::details[例题[二逼平衡树（树套树）](https://loj.ac/problem/106)]{.note open="false"}
:::

:::details[例题[ZOJ 2112 Dynamic Rankings](http://acm.zju.edu.cn/onlinejudge/showProblem.do?problemId=1112)]{.note open="false"}
:::
