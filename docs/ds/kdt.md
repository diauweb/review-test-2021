---
author: kenlig, mgt, Chrogeek, Henry-ZHR, Rainboy, ouuan, Ir1d, Xeonacid
title: K-D Tree
tags:
  - ds
...
:::details[例题[luogu P1429 平面最近点对（加强版）](https://www.luogu.com.cn/problem/P1429)]{.note open="true"}
...
:::details[例题[「CQOI2016」K 远点对](https://loj.ac/problem/2043)]{.note open="true"}
...
:::details[例题[luogu P4148 简单题](https://www.luogu.com.cn/problem/P4148)]{.note open="true"}
