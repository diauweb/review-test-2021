---
author: ksyx, 夜轮_NachtgeistW, WenzelTian, Early, kenlig, Shuhao, hly1204,
  Guojie, Ir1dXD, YYC, mgt, GavinZhengOI, Henry-ZHR, XTh3G4p, orzAtalod,
  Haoshen, ouuan, Billchenchina, Xeonacid
title: 线段树
tags:
  - ds
...
::::details[[luogu P3372【模板】线段树 1](https://www.luogu.com.cn/problem/P3372)]{.note open="true"}
已知一个数列，你需要进行下面两种操作：
...
::::details[[luogu P3373【模板】线段树 2](https://www.luogu.com.cn/problem/P3373)]{.note open="true"}
已知一个数列，你需要进行下面三种操作：
...
::::details[[HihoCoder 1078 线段树的区间修改](https://cn.vjudge.net/problem/HihoCoder-1078)]{.note open="true"}
...
::::details[[2018 Multi-University Training Contest 5 Problem G. Glad You Came](https://vjudge.net/problem/HDU-6356)]{.note open="true"}
