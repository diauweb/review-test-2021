---
author: WenzelTian, kenlig, Nathan, mgt, Leo, The-UltimateGamer, 夜轮_NachtgeistW,
  Margatroid, abc1763613206, Jacob, ouuan, sshwy, Ir1d, Xeonacid
title: 队列
tags:
  - ds
...
C++ STL 中实现了 [队列 `std::queue`](https://zh.cppreference.com/w/cpp/container/queue) 和 [优先队列 `std::priority_queue`](https://zh.cppreference.com/w/cpp/container/priority\_queue) 两个类，定义于头文件 [`<queue>`](https://zh.cppreference.com/w/cpp/header/queue) 中。
...
:::details[[LOJ6515「雅礼集训 2018 Day10」贪玩蓝月](https://loj.ac/problem/6515)]{.note open="true"}
一个双端队列（deque），m 个事件：
