---
author: WenzelTian, 忘怀, ranwen, izlyforever, Shuhao, mgt, Elitedj, nanmenyangde,
  zyj2297349886, sshwy, Henry-ZHR, yizr-cnyali, ouuan, Xeonacid
title: 四边形不等式优化
tags:
  - dp
  - opt
...
**本页面主要译自英文版博文 [Divide and Conquer DP](https://cp-algorithms.com/dynamic\_programming/divide-and-conquer-dp.html)。版权协议为 CC-BY-SA 4.0。**
