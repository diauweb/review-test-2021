---
author: Z., WenzelTian, InFaNg, Shuhao, mgt, LincolnYe, Chrogeek, ouuan
title: 动态规划基础
tags:
  - dp
...
[Viterbi algorithm](https://en.wikipedia.org/wiki/Viterbi\_algorithm) 之前写词性标注的时候有用到，好像用在输入法里面也是类似的。
