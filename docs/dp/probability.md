---
author: kenlig, imp, LeBronGod, mgt, Patchouliys, hongchenhao, 邵晨恒
title: 概率 DP
tags:
  - dp
...
:::details[例题 [Codeforces 148 D Bag of mice](https://codeforces.com/problemset/problem/148/D)]{.note open="false"}
...
:::details[例题 [POJ2096 Collecting Bugs](http://poj.org/problem?id=2096)]{.note open="false"}
...
:::details[例题 [「NOIP2016」换教室](http://uoj.ac/problem/262)]{.note open="false"}
...
:::details[[CodeForces 24 D Broken robot](https://codeforces.com/problemset/problem/24/D)]{.note open="false"}
