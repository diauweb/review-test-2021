---
author: kenlig, rui_er, thredreams, Danni, mgt, Ravenclaw-OIer, Early, 邵晨恒,
  Shuhao, sshwy, H-J-Granger, Henry-ZHR, ouuan, Billchenchina, 心旷神怡, Ir1d
title: 树形 DP
tags:
  - dp
...
:::details[例题 [洛谷 P1352 没有上司的舞会](https://www.luogu.com.cn/problem/P1352)]{.note open="true"}
...
:::details[例题 [洛谷 P2014 CTSC1997 选课](https://www.luogu.com.cn/problem/P2014)]{.note open="true"}
...
:::details[例题 [\[POI2008\]STA-Station](https://www.luogu.com.cn/problem/P3478)]{.note open="true"}
...
[^note1]: [子树合并背包类型的 dp 的复杂度证明 - LYD729 的 CSDN 博客](https://blog.csdn.net/lyd\_7\_29/article/details/79854245)
