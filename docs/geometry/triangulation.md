---
author: mgt, 忘怀, corchis-S, Xiaodai, xehoth, Ir1d
title: 三角剖分
tags:
  - geometry
...
*   \[1][Wikipedia - Triangulation (geometry)](https://en.wikipedia.org/wiki/Triangulation\_\(geometry\))
*   \[2][Wikipedia - Delaunay triangulation](https://en.wikipedia.org/wiki/Delaunay\_triangulation)
*   \[3]Samuel Peterson -[Computing Constrained Delaunay Triangulations in 2-D (1997-98)](http://www.geom.uiuc.edu/\~samuelp/del\_project.html)
