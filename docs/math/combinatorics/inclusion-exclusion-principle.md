...
:::details[不定方程非负整数解计数]{.note open="true"}
...
:::details[HAOI2008 硬币购物]{.note open="true"}
...
:::details[完全图子图染色问题]{.note open="true"}
...
:::details[求最大公约数为 $k$ 的数对个数]{.note open="true"}
...
:::details[[PKUWC2018 随机游走](https://loj.ac/problem/2542)]{.note open="true"}
...
[Cyhlnj《有标号的 DAG 计数系列问题》](https://blog.csdn.net/oi\_konnyaku/article/details/84862271)

[Wikipedia - 全序关系](https://en.wikipedia.org/wiki/Total\_order)
