---
author: Danni, Great-designer, mgt
title: 群论简介
tags:
  - math
...
*   \[1][Group (mathematics) - Wikipedia](https://en.wikipedia.org/wiki/Group\_\(mathematics\))
*   \[2][Group theory - Wikipedia](https://en.wikipedia.org/wiki/Group\_theory)
