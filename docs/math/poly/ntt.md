---
author: Danni, tigerruanyifan, mgt, ranwen, Omega癸, GeZiyue, ouuan, Ir1d, Sshwy,
  Xeonacid, Henry, TrisolarisHD
title: 快速数论变换
tags:
  - math
  - poly
...
下面是一个大数相乘的模板，[参考来源](https://blog.csdn.net/blackjack\_/article/details/79346433)。
...
*   \[3][Number-theoretic transform(NTT) - Wikipeia](https://en.wikipedia.org/wiki/Discrete\_Fourier\_transform\_\(general\)#Number-theoretic\_transform)
