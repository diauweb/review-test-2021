...
:::details[例题 [LOJ 166 拉格朗日插值 2](https://loj.ac/p/166)]{.note open="true"}
...
:::details[例题 [P5408 第一类斯特林数·行](https://www.luogu.com.cn/problem/P5408)]{.note open="true"}
...
:::details[例题 [P5282 【模板】快速阶乘算法](https://www.luogu.com.cn/problem/P5282)]{.note open="true"}
...
$$
T(n)=T(n/2)+O(\sqrt n\log n)=O(\sqrt n\log n)
$$

### 模素数意义下二项式系数前缀和

:::details[例题 [LOJ 6386 组合数前缀和](https://loj.ac/p/6386)]{.note open="true"}
...
:::details[例题 [P5702 调和级数求和](https://www.luogu.com.cn/problem/P5702)]{.note open="true"}
