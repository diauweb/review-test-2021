---
author: qwq, Zhikai, Great-designer
title: 数论分块
tags:
  - math
  - number-theory
...
:::details[关于证明最后的小方块]{.note open="false"}
...
:::details[例题：[UVa11526 H(n)](https://onlinejudge.org/index.php?option=com\_onlinejudge\&Itemid=8\&category=27\&page=show\_problem\&problem=2521)]{.note open="true"}
...
:::details[N 维数论分块]{.note open="true"}
...
2.  [UVa11526 H(n)](https://onlinejudge.org/index.php?option=com\_onlinejudge\&Itemid=8\&category=27\&page=show\_problem\&problem=2521)（几乎可以当做模板题）
