---
author: Danni, WenzelTian, kenlig, Great-designer
title: 素数
tags:
  - math
  - number-theory
...
对数 n 进行 k 轮测试的时间复杂度是 $O(k \log^3n)$，利用 FFT 等技术可以优化到 [$O(k \log^2n \log \log n \log \log \log n)$](https://en.wikipedia.org/wiki/Miller%E2%80%93Rabin\_primality\_test#Complexity)。
...
:::details[例题 [Codeforces 27E. A number with a given number of divisors](https://codeforces.com/problemset/problem/27/E)]{.note open="true"}
...
:::details[例题 [ZOJ - More Divisors](https://zoj.pintia.cn/problem-sets/91827364500/problems/91827366061)]{.note open="true"}
...
4.  [Primality test - Wikipedia](https://en.wikipedia.org/wiki/Primality\_test)
