---
author: WenzelTian, mgt, H-J-Granger, Ir1dXD, 李瑞, Marcythm, Richard, landcold7,
  Xeonacid
title: 牛顿迭代法
tags:
  - math
...
关于牛顿迭代法的收敛性证明可参考 [citizendium - Newton method Convergence analysis](http://en.citizendium.org/wiki/Newton%27s\_method#Convergence\_analysis)
...
*   [UVa 10428 - The Roots](https://uva.onlinejudge.org/index.php?option=com\_onlinejudge\&Itemid=8\&category=16\&page=show\_problem\&problem=1369)
*   [LeetCode 69. x 的平方根](https://leetcode-cn.com/problems/sqrtx/)

    **本页面主要译自博文 [Метод Ньютона (касательных) для поиска корней](http://e-maxx.ru/algo/roots\_newton) 与其英文翻译版 [Newton's method for finding roots](https://cp-algorithms.com/num\_methods/roots\_newton.html)。其中俄文版版权协议为 Public Domain + Leave a Link；英文版版权协议为 CC-BY-SA 4.0。**
